...
namespace GT.Common.Application
{
    /// <summary>
    /// SingleProcessApplication uses a mutex synchronization object 
    /// to ensure that only one copy of process is running at a particular time.  
    /// It also allows for UI identification of the intial process 
    /// by bringing that window to the foreground.
    /// </summary>
    public class SingleProcessApplication : IDisposable
    {
        ...
        public SingleProcessApplication()
        {
        ...
        public SingleProcessApplication(string identifier)
        {
            //Initialize a named mutex and attempt to
            // get ownership immediately.
