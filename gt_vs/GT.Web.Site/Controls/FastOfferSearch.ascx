...
<div class="fastOfferSearch">
  ...
  <asp:Panel runat="server" ID="pnlActions" CssClass="actions">
    <asp:HyperLink runat="server" ID="hplSellingSearch" Text="<%# GT.Localization.Resources.CommonResources.SearchInSelling %>" SkinID="hplSellingSearchSkin" NavigateUrl="~/Selling" />
    <%--or--%>
    <asp:HyperLink runat="server" ID="hplBuyingSearch" Text="<%# GT.Localization.Resources.CommonResources.SearchInBuying %>" SkinID="hplBuyingSearchSkin" NavigateUrl="~/Buying" />
  </asp:Panel>
</div>
