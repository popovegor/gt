    ...
    public class WMResult : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (transfer == null || transfer.FromTransferParticipant.ActualEntityType != GT.Global.Entities.EntityType.RealMoneySource ||
                    transfer.FromTransferParticipant.RealMoneySourceId != (int)RealMoneySourceType.WebMoney || transfer.Status != TransferStatus.Refused )
            {
            ...
            decimal amount = TypeConverter.ToDecimal(LMI_PAYMENT_AMOUNT.Replace('.', ','));
            ...
            // 1. Проверка флага тестового режима
