  ...
  <ContentTemplate>
    <ajaxToolkit:TabContainer runat="server" ID="tcFeedbacks" CssClass="tabConteiner tabConteinerBrown" AutoPostBack="true" OnActiveTabChanged="tcFeedbacks_ActiveTabChanged">
      <ajaxToolkit:TabPanel runat="server" >
        <HeaderTemplate><span><%# string.Format("{0} ({1})", Resources.CommonResources.Controls_UserFeedbacks_AsSeller, CountOfFeedbacksAsSeller)%></span> </HeaderTemplate>
        <ContentTemplate>
          ...
          <PagerStyle CssClass="gridPager" />
            <Columns>
              <asp:TemplateField>
                <ItemTemplate>
                  <dl class="feedback">
                    <dt>
                      <%= Resources.CommonResources.Controls_UserFeedbacks_DealTitle %>: </dt>
                    <dd class="title">
                    ...
                    <dt>
                      <%= Resources.CommonResources.Controls_UserFeedbacks_FromBuyer %>: </dt>
                    <dd>
                      <gt:User runat="server" ID="usFromUser" UserName="<%# Eval(FeedbackFields.FromUserName) %>" UserId="<%# Eval(FeedbackFields.FromUserId) %>" />
                    </dd>
                    <dt>
                      <%= Resources.CommonResources.Controls_UserFeedbacks_Rating%>:</dt>
                    <dd>
                      <%# Dictionaries.Instance.GetFeedbackTypeNameById((int)Eval(FeedbackFields.FeedbackTypeId)) %>
                    </dd>
                    <dt>
                      <%= Resources.CommonResources.Controls_UserFeedbacks_Comment%>: </dt>
                    <dd class="comment">
                      <%# Eval(FeedbackFields.Comment) %>
                      <div class="createdDate">
                        <%= Resources.CommonResources.Controls_UserFeedbacks_CreatedAt%>
            ...
            <EmptyDataTemplate>
              <asp:Literal runat="server" Text="<%# Resources.CommonResources.Controls_UserFeedbacks_NoFeedbacks %>" />
            </EmptyDataTemplate>
          </asp:GridView>
        </ContentTemplate>
      ...
      <ajaxToolkit:TabPanel runat="server" >
        <HeaderTemplate>
          <span><%# string.Format("{0} ({1})", Resources.CommonResources.Controls_UserFeedbacks_AsBuyer, CountOfFeedbacksAsBuyer) %></span>
        </HeaderTemplate>
        <ContentTemplate>
          ...
          <PagerStyle CssClass="gridPager" />
              ...
              <asp:TemplateField>
                <ItemTemplate>
                  <dl class="feedback">
                    ...
                    <dt>
                      <%= Resources.CommonResources.Controls_UserFeedbacks_FromSeller%>: </dt>
                    <dd>
                      <gt:User runat="server" ID="usFromUser" UserName="<%# Eval(FeedbackFields.FromUserName) %>" UserId="<%# Eval(FeedbackFields.FromUserId) %>" />
                    </dd>
                    <dt>
            ...
            <EmptyDataRowStyle CssClass="gridEmpty" />
            <EmptyDataTemplate>
              <asp:Literal ID="ltrNoData" runat="server" Text="<%# Resources.CommonResources.Controls_UserFeedbacks_NoFeedbacks %>" />
            </EmptyDataTemplate>
          </asp:GridView>
        </ContentTemplate>
      </ajaxToolkit:TabPanel>
