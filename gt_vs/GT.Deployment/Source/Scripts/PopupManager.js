...
GT.Ajax.Scripts.SignInPopup = function(popupId, popupTitle, onSuccess, onFailure) {
  this._popupId = popupId;
  this._redirectUrl = null;
  this._onSuccessInternal = onSuccess;
  this._onFailureInternal = onFailure;
  ...
  GT.Ajax.Scripts.SignInPopup.initializeBase(this);
};

GT.Ajax.Scripts.SignInPopup.prototype = {
  ...
  signIn: function(userName, password, remember) {
    ...
    , null
    , this._redirectUrl
    , this._onSuccessInternal
    , this._onFailureInternal
    , null);
  }
};

GT.Ajax.Scripts.SignInPopup.registerClass('GT.Ajax.Scripts.SignInPopup');
...
ViewOfferInfo.Url = '/DetailsInfo/OfferInfo.aspx?id={OfferID}&WindowMode=Popup';
...
ViewBuyingOfferInfo.Url = '/DetailsInfo/BuyingOfferInfo.aspx?id={BuyingOfferID}&WindowMode=Popup';
...
EditSelling.Url = '/Offers/EditSelling.aspx?Id={Id}&url={RedirectUrl}&om=Popup';
...
EditBuying.Url = '/Offers/EditBuying.aspx?Id={Id}&url={RedirectUrl}&om=Popup';
